                        ...
                        <div class="col-md-4 my-2">
                            <div style="box-shadow: 0 0  20px #ddd;">
                                @if ($materi->thumbnail == null)
                                    ...
                                    @else
                                        <div class="position-relative"
                                            style="height: 320px; background-image: url('{{ $materi->thumbnail }}'); background-position: center; background-size: cover;">
                                @endif
                                <div class="position-absolute px-3 py-4 materi-description"
                                    style="right: 0; bottom: 0; left: 0;">
                                    <h3 class="h6"><a href="{{ route('materis.show', $materi->slug) }}"
