...
@section('content')
    <div class="page-inner">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
            <div>
                <h3 class="fw-bold mb-3">Edit Materi</h3>
            </div>
                        ...
                        <form action="{{ route('materi.update', $materi->id) }}" method="POST">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="volume"
                                            ...
                                            value="{{ old('volume', $materi->volume) }}" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="satuan"
                                            ...
                                            value="{{ old('satuan', $materi->satuan) }}" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-select form-control @error('kategori') is-invalid @enderror"
                                    ...
                                    <option value="bawaan"
                                        {{ old('kategori', $materi->kategori) == 'bawaan' ? 'selected' : '' }}>Bawaan
                                    </option>
                                    <option value="pilihan"
                                        {{ old('kategori', $materi->kategori) == 'pilihan' ? 'selected' : '' }}>Pilihan
                                    </option>
                                </select>
                            </div>
                            <div class="form-group">
